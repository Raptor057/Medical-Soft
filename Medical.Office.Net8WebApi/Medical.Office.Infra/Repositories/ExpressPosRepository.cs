...
public class ExpressPosRepository : IPOSInterfacesRepository.IProductoService, IPOSInterfacesRepository.IVentaService, IPOSInterfacesRepository.ICorteService, IPOSInterfacesRepository.IReporteService
{
    private readonly ExpressPossSqlDb _db;
    private readonly ILogger<ExpressPosRepository> _logger;

    public ExpressPosRepository(ILogger<ExpressPosRepository> logger,ExpressPossSqlDb db)
    {
        _db = db;
        _logger=logger;
    }
