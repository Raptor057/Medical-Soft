...
internal sealed class ObtenerResumenDeCortesPorDiaHandler : IInteractor<ObtenerResumenDeCortesPorDiaRequest, ObtenerResumenDeCortesPorDiaResponse>
{
    ...
    private readonly IPOSInterfacesRepository.IReporteService _reporteService;

    public ObtenerResumenDeCortesPorDiaHandler(ILogger<ObtenerResumenDeCortesPorDiaHandler> logger, IPOSInterfacesRepository.IReporteService reporteService)
    {
        _logger = logger;
