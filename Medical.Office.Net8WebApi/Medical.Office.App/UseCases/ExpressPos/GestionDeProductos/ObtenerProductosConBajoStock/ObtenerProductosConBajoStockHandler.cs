...
internal sealed class ObtenerProductosConBajoStockHandler : IInteractor<ObtenerProductosConBajoStockRequest, ObtenerProductosConBajoStockResponse>
{
    ...
    private readonly IPOSInterfacesRepository.IProductoService _productoService;

    public ObtenerProductosConBajoStockHandler(ILogger<ObtenerProductosConBajoStockHandler> logger, IPOSInterfacesRepository.IProductoService productoService)
    {
        _logger = logger;
