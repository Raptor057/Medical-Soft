...
internal sealed class ObtenerTodosLosCortesHandler : IInteractor<ObtenerTodosLosCortesRequest, ObtenerTodosLosCortesResponse>
{
    ...
    private readonly IPOSInterfacesRepository.ICorteService _corteService;

    public ObtenerTodosLosCortesHandler(ILogger<ObtenerTodosLosCortesHandler> logger, IPOSInterfacesRepository.ICorteService corteService)
    {
        _logger = logger;
