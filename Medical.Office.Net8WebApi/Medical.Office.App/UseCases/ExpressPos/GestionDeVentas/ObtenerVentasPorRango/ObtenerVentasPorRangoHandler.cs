...
internal sealed class ObtenerVentasPorRangoHandler : IInteractor<ObtenerVentasPorRangoRequest, ObtenerVentasPorRangoResponse>
{
    ...
    private readonly IPOSInterfacesRepository.IVentaService _ventaService;

    public ObtenerVentasPorRangoHandler(ILogger<ObtenerVentasPorRangoHandler> logger, IPOSInterfacesRepository.IVentaService ventaService)
    {
        _logger = logger;
